...
static const char* ImGui_ImplSdlVulkan_GetClipboardText(void* user_data)
{
    return SDL_GetClipboardText();
}

static void ImGui_ImplSdlVulkan_SetClipboardText(void* user_data, const char* text)
{
...
bool    ImGui_ImplSdlVulkan_Init(SDL_Window* window, bool install_callbacks, ImGui_ImplSdlVulkan_Init_Data *init_data)
{
...
void ImGui_ImplSdlVulkan_NewFrame(SDL_Window* window)
{
    ImGuiIO& io = ImGui::GetIO();
    ...
    // Setup time step
    double current_time = SDL_GetPerformanceCounter() / (double)SDL_GetPerformanceFrequency();
